...
CREATE PROC AgregarEmpleado @DNI CHAR(12), @NOMBRE VARCHAR(48), @APELLIDO VARCHAR(48), @SEXO CHAR(2),
...
CREATE PROC CambiarSueldo @DNI CHAR(12), @NUEVOSUELDO MONEY, @RESULTADO BIT OUTPUT
AS
BEGIN
	SET NOCOUNT ON
...
CREATE PROC DeshabilitarEmpleado @DNI CHAR(10), @RESULTADO BIT OUTPUT
AS
BEGIN
	SET NOCOUNT ON
